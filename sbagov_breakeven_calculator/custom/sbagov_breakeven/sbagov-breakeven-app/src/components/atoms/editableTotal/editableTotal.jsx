...
const errorContent = () => {
  return { content: "This field is required", pointing: "above" };
};
      ...
      >
        ...
        {!isEditing && (
          <Grid columns={2} stackable={false}>
            <Grid.Column
              data-testid="value"
              className="totalValue-container editableValue"
              computer={11}
              tablet={10}
              mobile={10}
