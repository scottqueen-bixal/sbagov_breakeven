      ...
      <Card.Content className="breakEvenWelcome-container">
        <Grid stackable>
          <Grid.Row columns={2} stretched>
            <Grid.Column width={4}>
              <Image alt="calculator icon" size="tiny" centered>
              ...
              <Card className="units">
                <Card.Content>
                  ...
                  <Card.Description extra="true">
                    ...
                    <div className="number">{`${formatNumber(
                      expectedUnits
                    )} units`}</div>
                    <p>{`your ${willBreakEven ? "profit" : "loss"} will be`}</p>
                    <div
                      className={`number ${willBreakEven ? "profit" : "loss"}`}
                    >
                      {profitOrLoss()}
                    </div>
                  </Card.Description>
                  ...
                  <Card.Description>
                    ...
                    {!willBreakEven && (
                      <>
                        ...
                        <p>
                          <span className="number loss">
                            {" "}
                            {formatNumber(breakEvenUnits - expectedUnits)}{" "}
                          </span>
                          more to break even
                        </p>
                      </>
...
BreakEvenResultsCard.propTypes = {
  expectedUnits: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  breakEvenUnits: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  breakEvenRevenue: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  pricePerUnit: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  variableCost: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  fixedCost: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
};
